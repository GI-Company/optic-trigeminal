...
- [ ] Create WASM wrapper C++ code (following binding contract)
- [ ] Test basic WASM compilation with minimal inference function
- [ ] Verify: No HTTP server code in WASM bindings
